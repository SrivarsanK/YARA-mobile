...
export const KioskScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.content}>
    <View style={styles.hero}>
      ...
      <Text style={styles.subtitle}>Fullscreen landscape display — large ETA, occupancy, event log</Text>
    </View>
    <View style={styles.placeholder}>
      <Text style={styles.placeholderText}>Screen scaffold — implementation in Phase 4</Text>
    </View>
  </ScrollView>
);
