...
export const LiveMapScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.content}>
    <View style={styles.hero}>
      ...
      <Text style={styles.subtitle}>Real-time bus position with animated marker and ETA bottom sheet</Text>
    </View>
    <View style={styles.placeholder}>
      <Text style={styles.placeholderText}>Screen scaffold — implementation in Phase 2</Text>
    </View>
  </ScrollView>
);
