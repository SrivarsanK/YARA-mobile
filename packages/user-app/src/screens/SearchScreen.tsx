...
export const SearchScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.content}>
    <View style={styles.hero}>
      ...
      <Text style={styles.subtitle}>Debounced route/stop search with autocomplete suggestions</Text>
    </View>
    <View style={styles.placeholder}>
      <Text style={styles.placeholderText}>Screen scaffold — implementation in Phase 3</Text>
    </View>
  </ScrollView>
);
