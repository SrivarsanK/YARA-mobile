...
export const ScenarioScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.content}>
    <View style={styles.hero}>
      ...
      <Text style={styles.subtitle}>Pre-built demo scenarios - 90s judge demo, stress test, recovery</Text>
    </View>
    <View style={styles.placeholder}>
      <Text style={styles.placeholderText}>Screen scaffold - implementation in Phase 6</Text>
    </View>
  </ScrollView>
);
